...
export class UpdateUnitRoomDto {
  ...
  pricingTier?: (typeof PRICING_TIERS)[number] | null;
  ...
  @Min(0)
  @Max(10000000)
  baseChargePerDay?: number | null;

  // Isolation
  @IsOptional() @IsBoolean() isIsolation?: boolean;

  @IsOptional()
  @Transform(({ value }) => (value == null ? undefined : String(value).trim().toUpperCase()))
  @IsIn(ISOLATION_TYPES as unknown as string[])
  isolationType?: (typeof ISOLATION_TYPES)[number] | null;
