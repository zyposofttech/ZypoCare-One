...
function EmpanelmentEditorDialog({
  ...
  React.useEffect(() => {
    ...
    setForm({
      ...
      cityCategory: initial?.cityCategory ?? "",
  ...
  async function onSubmit() {
    ...
    if (!form.cityCategory) return setErr("City category is required");
      ...
      >
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-indigo-700 dark:text-indigo-400">
            ...
            {initial ? "Edit ECHS Empanelment" : "Configure ECHS Empanelment"}
          </DialogTitle>
          <DialogDescription>
            Set up branch-level ECHS empanelment details before syncing to operations.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Select value={form.cityCategory} onValueChange={(v) => set("cityCategory", v)}>
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                <Label>Scheme</Label>
                <Input value={SCHEME} readOnly disabled />
              </div>
            </div>
          </div>
        </div>
...
export default function EchsPage() {
  ...
  const {
    ...
    module: "compliance-schemes-echs",
  });
  ...
  const refresh = React.useCallback(
    async (showToast = false) => {
      ...
      try {
        ...
        if (showToast) {
          toast({
            title: "ECHS refreshed",
            description: "Loaded latest empanelment and rate cards.",
          });
        }
      } catch (e) {
        const msg = errorMessage(e, "Failed to load ECHS data");
        setErr(msg);
  ...
  async function handlePushToInfra() {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Sync failed",
        description: errorMessage(e, "Failed to sync ECHS configuration"),
      });
    } finally {
      setSyncing(false);
    }
  ...
  async function handleUnlink() {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Unlink failed",
        description: errorMessage(e, "Failed to unlink ECHS configuration"),
      });
    } finally {
      setSyncing(false);
    }
        ...
        <div className="grid gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 text-sm text-zc-muted">
                  Manage ECHS empanelment and scheme rate cards for the active branch.
                </div>
              </div>
            </div>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm">
                Search rate cards and manage ECHS linkage with operations.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">
                Configure ECHS empanelment details and synchronize to infrastructure operations.
              </CardDescription>
            </CardHeader>
            <Separator />
              ...
              <table className="w-full text-sm">
                <thead className="bg-zc-panel/20 text-xs text-zc-muted">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-semibold">City Category</th>
                ...
                <tbody>
                  ...
                  {empanelment ? (
                    <tr className="border-t border-zc-border hover:bg-zc-panel/20">
                      ...
                      <td className="px-4 py-3 text-zc-muted">{empanelment.cityCategory || "-"}</td>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">
                Track ECHS tariff versions and freeze finalized cards.
              </CardDescription>
            </CardHeader>
            <Separator />
