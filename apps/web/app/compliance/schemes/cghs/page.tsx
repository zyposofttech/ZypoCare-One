      ...
      >
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-indigo-700 dark:text-indigo-400">
            ...
            {initial ? "Edit CGHS Empanelment" : "Configure CGHS Empanelment"}
          </DialogTitle>
          <DialogDescription>
            Set up branch-level CGHS empanelment details before syncing to operations.
          </DialogDescription>
        </DialogHeader>
...
export default function CghsPage() {
  ...
  const {
    ...
    module: "compliance-schemes-cghs",
  });
  ...
  const refresh = React.useCallback(
    async (showToast = false) => {
      ...
      try {
        ...
        if (showToast) {
          toast({
            title: "CGHS refreshed",
            description: "Loaded latest empanelment and rate cards.",
          });
        }
      } catch (e) {
        const msg = errorMessage(e, "Failed to load CGHS data");
        setErr(msg);
  ...
  async function handlePushToInfra() {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Sync failed",
        description: errorMessage(e, "Failed to sync CGHS configuration"),
      });
    } finally {
      setSyncing(false);
    }
  ...
  async function handleUnlink() {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Unlink failed",
        description: errorMessage(e, "Failed to unlink CGHS configuration"),
      });
    } finally {
      setSyncing(false);
    }
        ...
        <div className="grid gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 text-sm text-zc-muted">
                  Manage CGHS empanelment and scheme rate cards for the active branch.
                </div>
              </div>
            </div>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm">
                Search rate cards and manage CGHS linkage with operations.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">
                Configure CGHS empanelment details and synchronize to infrastructure operations.
              </CardDescription>
            </CardHeader>
            <Separator />
          ...
          <Card className="overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-sm">
                Track CGHS tariff versions and freeze finalized cards.
              </CardDescription>
            </CardHeader>
            <Separator />
